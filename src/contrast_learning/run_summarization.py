...
def main():
    ...
    def preprocess_function(examples):
        ...
        # print('输入样本为',list_keys)
        # print('正负样本标记',examples['neg-pos_label'])
        ...
        ############################################################## 增加正负样本的判断符
        print('增加正负样本的判断符')
        model_inputs['neg_pos_label']=[]
        for flag in examples['neg-pos_label']:
            model_inputs['neg_pos_label'].append(flag)
        return model_inputs
