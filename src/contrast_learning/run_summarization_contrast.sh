...
STEP=100
DIM=768
EMBEDPATH=/autodl-fs/RHO-main/OpenKE/TransE_768_result/ent_rel_embeddings
...
python run_summarization.py \
  ...
  --model_name_or_path="/autodl-fs/RHO-main/bart_base" \
  --text_column=history \
  --summary_column=response \
  --train_file=autodl-fs/RHO-main/contrast_data/train_neg_pos.csv \
